        ...
        <div class="bg-white border rounded-2xl p-6 shadow-sm space-y-4">
          ...
          <form onsubmit="changeUserPassword(event)" id="change-pw-form" class="space-y-3 text-xs">
            <div>
              ...
              <div class="relative">
                <input type="password" id="set-curr-pw" class="w-full border rounded-lg px-3 py-2 pr-10 text-xs focus:outline-none" placeholder="••••••••" required>
                <button type="button" onclick="window.togglePwVisibility('set-curr-pw', this)" class="absolute inset-y-0 right-0 flex items-center px-2.5 text-slate-400 hover:text-brand-purple transition-colors" tabindex="-1" aria-label="Show password">
            ...
            <div class="grid grid-cols-2 gap-4">
              <div>
                ...
                <div class="relative">
                  <input type="password" id="set-new-pw" class="w-full border rounded-lg px-3 py-2 pr-10 text-xs focus:outline-none" placeholder="••••••••" required>
                  <button type="button" onclick="window.togglePwVisibility('set-new-pw', this)" class="absolute inset-y-0 right-0 flex items-center px-2.5 text-slate-400 hover:text-brand-purple transition-colors" tabindex="-1" aria-label="Show password">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/><path stroke-linecap="round" stroke-linejoin="round" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.477 0 8.268 2.943 9.542 7-1.274 4.057-5.065 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/></svg>
                  </button>
                </div>
              </div>
              <div>
                ...
                <div class="relative">
                  <input type="password" id="set-new-pw-confirm" class="w-full border rounded-lg px-3 py-2 pr-10 text-xs focus:outline-none" placeholder="••••••••" required>
                  <button type="button" onclick="window.togglePwVisibility('set-new-pw-confirm', this)" class="absolute inset-y-0 right-0 flex items-center px-2.5 text-slate-400 hover:text-brand-purple transition-colors" tabindex="-1" aria-label="Show password">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/><path stroke-linecap="round" stroke-linejoin="round" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.477 0 8.268 2.943 9.542 7-1.274 4.057-5.065 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/></svg>
                  </button>
                </div>
              </div>
